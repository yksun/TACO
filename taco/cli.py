...
def parse_args():
    ...
    parser = argparse.ArgumentParser(prog='TACO', description='TACO v1.5.2 - Telomere-Aware Contig Optimization')
    ...
    parser.add_argument('--version', action='version', version='TACO v1.5.2')
    ...
    for s in args.steps:
        if s < 0 or s > 14:
            parser.error(
                f"Invalid step: {s}. TACO v1.5.2 uses steps 0-14. "
